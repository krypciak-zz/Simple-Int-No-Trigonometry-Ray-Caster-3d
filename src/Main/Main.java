...
class g1 {
	...
	void render() {
		...
		switch(pa) {
		case 0: 	laxS = 0;	layS=-100;		axp=-add;	ayp=0; 	break; 
		
		case 45: 	laxS=50;	layS=-50;		axp=-add/2;	ayp=-add/2;	break; 
		
		case 90: 	laxS=100;	layS=0;			axp=0;	ayp=-add;	break; 
		
		case 135: 	laxS=50; 	layS=50;		axp=add/2;	ayp=-add/2;	break; 
		
		case 180: 	laxS=0; 	layS=100; 		axp=-add;	ayp=0;	break; 
		
		case 225: 	laxS=-50; 	layS=50; 		axp=-add/2;	ayp=-add/2;	break; 
		
		case 270: 	laxS=-100;	layS=0; 		axp=0;	ayp=add; 	break; 
		
		case 315: 	laxS=-50;	layS=-50; 		axp=add/2;	ayp=-add/2;	break;
	...
	void initFrame() {
		...
		f.addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent e) {
				...
				case 'a': px--; break;
				case 'd': px++; break;
				case 'm': pa+=45; if(pa==360) pa=0; break;
				case 'n': pa-=45; if(pa==-45) pa=315; break;
